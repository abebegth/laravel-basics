  ...
  <body class="bg-light-gray" id="body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 mb-4">
                                <input id="name" type="text" name="name" class="form-control input-lg" aria-describedby="nameHelp" placeholder="Name">
                            </div>
                            <div class="form-group col-md-12 mb-4">
                                <input id="email" type="email" name="email" class="form-control input-lg" aria-describedby="emailHelp" placeholder="Email">
                            </div>
                            <div class="form-group col-md-12 ">
                                <input id="password" type="password" name="password" class="form-control input-lg" placeholder="Password">
                            </div>
                            <div class="form-group col-md-12 ">
                                <input id="password_confirmation" type="password" name="password_confirmation" class="form-control input-lg" placeholder="Confirm Password">
                            </div>
                            <div class="col-md-12">
          ...
          <div class="copyright pl-0">
            <p class="text-center">&copy; 2018 Copyright Easy Dashboard by
              <a class="text-primary" href="http://www.abebegetaneh.com/" target="_blank">Abebe Gietaneh</a>.
            </p>
          </div>
        </div>
</body>
