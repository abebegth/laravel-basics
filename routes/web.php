...
// USER PROFILE ROUTES
Route::get('/user/edit-profile', [ChangePassword::class, 'editProfile'])->name('profile.edit');
Route::post('/user/update-profile', [ChangePassword::class, 'updateProfile'])->name('profile.update');
